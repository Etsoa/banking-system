...
public class UtilisateurServiceBean implements UtilisateurServiceRemote {
     ...
     */
    private com.example.centralizer.dto.comptecourant.Utilisateur convertToDTO(Utilisateur entity) {
        if (entity == null) {
            return null;
        }
        com.example.centralizer.dto.comptecourant.Utilisateur dto = new com.example.centralizer.dto.comptecourant.Utilisateur();
        ...
        dto.setRoleUtilisateur(entity.getRoleUtilisateur());
        return dto;
    }

    /**
     * Convertit un DTO Utilisateur en entité
     */
    private Utilisateur convertToEntity(com.example.centralizer.dto.comptecourant.Utilisateur dto) {
        if (dto == null) {
            return null;
        }
        ...
        entity.setRoleUtilisateur(dto.getRoleUtilisateur());
        return entity;
    }
     ...
     */
    @Override
    public com.example.centralizer.dto.comptecourant.Utilisateur getUtilisateurConnecte() throws CompteCourantException {
        if (!estConnecte()) {
     ...
     */
    @Override
    public java.util.List<com.example.centralizer.dto.comptecourant.Utilisateur> getAllUtilisateurs() throws CompteCourantException {
        exigerAutorisation("utilisateurs", "read");
        
        try {
            java.util.List<Utilisateur> entities = em.createQuery("SELECT u FROM Utilisateur u", Utilisateur.class).getResultList();
     ...
     */
    @Override
    public com.example.centralizer.dto.comptecourant.Utilisateur getUtilisateurById(Integer id) throws CompteCourantException {
        exigerAutorisation("utilisateurs", "read");
     ...
     */
    @Override
    public com.example.centralizer.dto.comptecourant.Utilisateur createUtilisateur(com.example.centralizer.dto.comptecourant.Utilisateur utilisateur) throws CompteCourantException {
        ...
        try {
            ...
            Utilisateur entity = convertToEntity(utilisateur);
            em.persist(entity);
     ...
     */
    @Override
    public com.example.centralizer.dto.comptecourant.Utilisateur updateUtilisateur(com.example.centralizer.dto.comptecourant.Utilisateur utilisateur) throws CompteCourantException {
        ...
        try {
            ...
            Utilisateur updated = em.merge(convertToEntity(utilisateur));
     ...
     */
    private void validateUtilisateurData(com.example.centralizer.dto.comptecourant.Utilisateur utilisateur) throws CompteCourantException {
