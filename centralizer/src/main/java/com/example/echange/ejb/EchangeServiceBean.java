...
public class EchangeServiceBean implements EchangeServiceRemote {
    ...
    /**
     * Convertit une entité Echange en DTO
     */
    private com.example.centralizer.dto.echange.Echange convertToDTO(Echange entity) {
        if (entity == null) {
            return null;
        }
        com.example.centralizer.dto.echange.Echange dto = new com.example.centralizer.dto.echange.Echange();
    ...
    /**
     * Convertit un DTO Echange en entité
     */
    private Echange convertToEntity(com.example.centralizer.dto.echange.Echange dto) {
        if (dto == null) {
            return null;
        }
        Echange entity = new Echange();
    ...
    @Override
    public List<com.example.centralizer.dto.echange.Echange> getAllEchanges() {
     ...
     */
    @Override
    public List<com.example.centralizer.dto.echange.Echange> getEchangesActifs(LocalDate date) {
        List<com.example.centralizer.dto.echange.Echange> actifs = new ArrayList<>();
        for (Echange e : echanges) {
            if (e.estActif(date)) {
                actifs.add(convertToDTO(e));
            }
        }
        return actifs;
    }
    ...
    @Override
    public void addEchange(com.example.centralizer.dto.echange.Echange e) {
        if (e == null) {
            throw new EchangeException("Echange null");
        }
        echanges.add(convertToEntity(e));
