...
/**
 * DTO pour représenter une transaction avec les frais appliqués (Compte Dépôt)
 */
public class TransactionAvecFrais {
    ...
    @JsonProperty("hasFrais")
    private boolean hasFrais;
    ...
    public boolean isHasFrais() {
        return hasFrais;
    }

    public void setHasFrais(boolean hasFrais) {
        this.hasFrais = hasFrais;
    }
