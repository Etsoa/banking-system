...
public class TransfertAvecFrais {
    ...
    public TransfertAvecFrais(Transfert transfert) {
        this.idTransfert = transfert.getId() != null ? transfert.getId().toString() : null;
        this.envoyer = transfert.getEnvoyer();
        this.receveur = transfert.getReceveur();
        this.montant = transfert.getMontant();
        this.dateTransfert = transfert.getDateTransfert();
    }
